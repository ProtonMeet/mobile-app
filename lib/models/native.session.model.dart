...
class UserInfo {
  ...
  factory UserInfo.fromProtonUserSession(ProtonUserSession protonUserSession) {
    return UserInfo(
      userId: protonUserSession.userId,
      userMail: protonUserSession.userMail,
      userName: protonUserSession.userName,
      userDisplayName: protonUserSession.userDisplayName ?? "",
      sessionId: protonUserSession.sessionId,
      accessToken: protonUserSession.accessToken,
      refreshToken: protonUserSession.refreshToken,
      scopes: protonUserSession.scopes.join(","),
      userKeyID: protonUserSession.userKeyId,
      userPrivateKey: protonUserSession.userPrivateKey,
      userPassphrase: protonUserSession.userPassphrase,
    );
  }
