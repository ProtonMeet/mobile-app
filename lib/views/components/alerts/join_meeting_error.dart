...
Future<void> showJoinMeetingErrorDialog(
  ...
  return Future.delayed(Duration.zero, () {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (context.mounted) {
        showDialog(
          context: context,
          builder: (_) => JoinMeetingErrorModal(
...
Future<void> showJoinMeetingErrorBottomSheet(
  BuildContext context, {
  required String errorMessage,
  String? errorDetails,
  String? meetingLink,
...
class JoinMeetingErrorModal extends StatefulWidget {
  const JoinMeetingErrorModal({
  ...
  @override
  State<JoinMeetingErrorModal> createState() => _JoinMeetingErrorModalState();
}

class _JoinMeetingErrorModalState extends State<JoinMeetingErrorModal> {
  ...
  void _onClose() {
    // Just pop the error dialog - dashboard is already in background
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  "Unable to join the meeting, please check the meeting link and try again.",
                                  textAlign: TextAlign.center,
