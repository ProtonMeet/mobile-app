...
import 'package:meet/views/scenes/core/nested.navigator.dart';
...
abstract class ViewBase<V extends ViewModel> extends StatefulWidget {
  ...
  Widget buildDrawerNavigator(
    ...
    return Responsive(
      mobile: _buildMobile(context, appBar, drawer, content, onDrawerChanged),
    ...
    return Stack(
      children: [
        Scaffold(
          ...
          drawer: viewModel.currentSize == ViewSize.mobile
              ? null
              : drawer(context),
          onDrawerChanged: viewModel.currentSize == ViewSize.mobile
              ? null
              : onDrawerChanged,
...
class ViewState<V extends ViewModel> extends State<ViewBase>
  ...
  void initState() {
    ...
    super.initState();
    final streamDatasourceChanged = viewModel.datasourceChanged.listen((
      viewModel,
    ) {
      setState(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return lockOverlay == null
        ...
        : Stack(children: [widget.build(context), lockOverlay]);
  }
