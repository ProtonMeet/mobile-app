...
import 'package:meet/managers/channels/platform.channel.event.dart';
...
class PlatformChannelManager extends Bloc<ChannelEvent, NativeLoginState>
  ...
  final toNativeChannel = const MethodChannel('me.proton.meet/native.views');
  final fromNativeChannel = const MethodChannel('me.proton.meet/app.view');
