...
import 'package:meet/managers/users/user.manager.event.dart';
import 'package:meet/managers/users/user.manager.state.dart';
...
class UserManager extends Bloc<UserManagerEvent, UserManagerState>
  ...
  //     throw Exception(
  //         "First key is null, cannot decrypt meet key. relogin or debug.");
  //   }
  //   return ProtonUserKey(
  //     id: userKeyID,
  //     privateKey: privateKey,
  ...
  Future<void> clear() async {
    ...
    for (var entry in map.entries) {
      final key = entry.key;
      l.logger.d('Clearing user manager key: $key');
    }
